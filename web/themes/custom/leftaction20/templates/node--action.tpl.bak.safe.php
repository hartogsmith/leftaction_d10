...
<!-- <div class="action-page-header row">
  <div class="col-xs-10 action-title">
     <h1 id="action_title"><?php print render($title) ?></h1>
  </div>
  <div class="col-xs-2 action-shares">
    <a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=[path]" id="fb_share">
      <i class="fa fa-arrow-right"></i><i class="fa fa-facebook-square"></i>
   </a>
    <a target="_blank" href="https://twitter.com/share?url=[path]" id="tw_share">
      <i class="fa fa-arrow-right"></i><i class="fa fa-twitter-square"></i>
    </a>
  </div>
</div> --> 
 ...
 <div id="node-<?php print $node->nid; ?>" class="row <?php print $classes; ?>"<?php print $attributes; ?>>
  <div class="col-sm-6 col-xs-12 leftcol col-sm-push-6">
     ...
     <?php
      //print render($content['field_salsa_link']);
    ...
    <div id="action_action">
      ...
      <?php
        ...
        <form id="salsa-petition" class="salsa" action="https://salsa.wiredforchange.com/save" method="POST">
          ...
          <input type="hidden" name="email_trigger_KEYS" value="<? print render($content['field_email_trigger_keys']['#items']['0']['value']); ?>"/>
          ...
          <? 
            ...
            print '<input title="Street 1" type="text" id="f4" name="Street" class="required salsa_street" placeholder="Street Address">';
            print '<input title="City" type="text" id="f5" name="City" class="required salsa_city" placeholder="City">';
          }
          ?>

          <input title="Zip Code" type="text" id="f1" name="Zip" class="blockInput salsa_zip required" value="" maxlength="10" placeholder="Zip Code">
          <? if ($showExtraFields == 1){
            print '<select id="f7" name="Country" class="required salsa_country">
          ...
          <textarea name="Comment" id="Comment" rows="4" cols="40" placeholder="Comments" ></textarea>
          <label for="Anonymous">
        ...
        <input type="hidden" name="linkKey" value="<? print $p_actionKey ?>"/>
        <input type="hidden" name="redirect" value="<? print render($content['field_redirect']['#items']['0']['url']); ?>">    
    ...
    $(document).ready(function () {
     ...
     //$("input:text:visible:first").focus();
      ...
      var sigCountChipAway;
        var actionKey = <? print $p_actionKey ?>;
